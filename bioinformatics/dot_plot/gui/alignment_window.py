...
class AlignmentWindow(tk.Toplevel):
    def __init__(self, master, *args, **kwargs):
        ...
        self.global_alignment_btn = tk.Button(self.alignment_btn_frame, text='GLOBAL', font=master.font_type,
        ...
        self.local_alignment_btn = tk.Button(self.alignment_btn_frame, text="LOCAL", font=master.font_type,
                                             bg=master.LIME)
